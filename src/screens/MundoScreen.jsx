  ...
  return (
    <View style={styles.containerBiblio}>
      ...
      <View style={styles.linear}>
        ...
        <Paragraph style={{ fontSize: 15, marginBottom: 10 }}>
          <Text style={{ fontWeight: "bold" }}> Um universo totalmente diferente: </Text>   
        ...
        <Paragraph style={{ fontSize: 15, marginBottom: 10, marginTop: "3%" }}>
          <Text style={{ fontWeight: "bold" }}> Um universo que supostamente é o nosso, mas com diferenças pontuais:</Text>
        ...
        <Paragraph style={{ fontSize: 15, marginBottom: 10, marginTop: "3%" }}>
          <Text style={{ fontWeight: "bold" }}> Um universo paralelo ao nosso, que pode ser acessado por tecnologia ou

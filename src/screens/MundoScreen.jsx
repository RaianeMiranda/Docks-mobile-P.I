  ...
  return (
    <View style={styles.containerpagina2}>
      ...
      <View style={styles.linear}>
        ...
        <Paragraph style={{ fontWeight: "bold"}}>
          Um universo totalmente diferente: Escrever um universo totalmente
        ...
        <Paragraph style={{ fontWeight: "bold", marginTop:"3%" }}>
          Um universo que supostamente é o nosso, mas com diferenças pontuais:
          Quando uma história se passa em um universo que supostamente é o
          nosso, mas com diferenças pontuais, isso significa que esse mundo tem
        ...
        <Paragraph style={{ fontWeight: "bold", marginTop:"3%"  }}>
          Um universo paralelo ao nosso, que pode ser acessado por tecnologia ou
          magia: Por fim, o universo paralelo é aquele que existe ao mesmo tempo
